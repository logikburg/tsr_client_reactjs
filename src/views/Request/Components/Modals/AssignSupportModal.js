...
class AssignSupportModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    return (
      <Modal keyboard={false}
        ...
        <ModalHeader toggle={() => this.hide()}>Support Assignment</ModalHeader>
        <ModalBody>
          <Container>
            <Row style={{ marginBottom: "10px" }}>
              <Col>
                <label>Please choose assignee for support:</label>
                <Select
                  placeholder="..."
                  options={options}
